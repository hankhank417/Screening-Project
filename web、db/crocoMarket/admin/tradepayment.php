			 ...
			 <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                           Print Trade Payment Details<small> </small>
                        </h1>
                    </div>
                </div> 
                 <!-- /. ROW  -->
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
									...
									<?php
										include ('db.php');
										$sql=   "SELECT *
                                                FROM `transactionDetails` INNER JOIN `trade` ON `trade`.`tId` = `transactionDetails`.`tId`
                                                GROUP BY transactionDetails.tId";
										...
										while($row = mysqli_fetch_array($re))
										{
											...
											{   $temp=0;
												echo"<tr class='gradeC'>
													...
													<td>".$row['eId']."</td>
													<td>".$row['tradeTime']."</td>
													<td><a href=printTradeNew.php?id=".$row['id'] ." <button class='btn btn-primary'> <i class='fa fa-print' ></i> Print</button></td>
													</tr>";
											}
											else
											{   $temp=1;
												echo"<tr class='gradeU'>
                                                    ...
                                                    <td>".$row['eId']."</td>
                                                    <td>".$row['tradeTime']."</td>
													<td><a href=printTradeNew.php?pid=".$row['id']." <button class='btn btn-primary'> <i class='fa fa-print' ></i> Print</button></td>
													</tr>";
