            ...
            <div id="page-inner">
                ...
                <div class="col-md-12">
                    <h1 class="page-header">
                        Print Return Payment Details<small> </small>
                    </h1>
                </div>
            </div> 				 
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
									...
									<?php
										include ('db.php');
										$sql="SELECT `returnProduct`.`id`,`returnOrder`.`rId` ,`returnOrder`.`sId` , `returnOrder`.`eId`,`returnOrder`.`sId`,`returnOrder`.`rDate` 
										...
										while($row = mysqli_fetch_array($re))
										{
											...
											{   $temp=0;
												echo"<tr class='gradeC'>
													...
													<td>".$row['eId']."</td>
													<td>".$row['rDate']."</td>
													<td><a href=printreturnnew.php?pid=".$row['id'] ." <button class='btn btn-primary'> <i class='fa fa-print' ></i> Print</button></td>
													</tr>";
											}
											else
											{   $temp=1;
												echo"<tr class='gradeU'>
                                                    ...
                                                    <td>".$row['eId']."</td>
                                                    <td>".$row['rDate']."</td>
                                                    <td><a href=printreturnew.php?pid=".$row['id'] ." <button class='btn btn-primary'> <i class='fa fa-print' ></i> Print</button></td>
                                                    </tr>";
